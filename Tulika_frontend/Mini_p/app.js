...
const PRODUCTS_DEFAULT = [
  ...
  {id:4, name:'Argan Silk Hair Mask',        category:'Haircare',  brand:'SilkRoots', price:1299, stock:2,  desc:'Nourishing mask with argan oil & keratin.', sku:'SLK-004', restock:5, image:''},
  {id:5, name:'Crystal Dew Moisturiser',     category:'Skincare',  brand:'Lumière',   price:1899, stock:31, desc:'Lightweight gel with hyaluronic acid.', sku:'LMR-005', restock:8, image:''},
  {id:6, name:'Satin Finish Foundation',     category:'Makeup',    brand:'NoirLab',   price:1599, stock:0,  desc:'Full-coverage foundation SPF 25.', sku:'NRL-006', restock:6, image:''},
  {id:7, name:'Lavender Dream Body Oil',     category:'Wellness',  brand:'AuraBliss', price:999,  stock:15, desc:'Calming oil with lavender & chamomile.', sku:'AUR-007', restock:5, image:''},
  {id:8, name:'Peptide Eye Cream',           category:'Skincare',  brand:'Lumière',   price:3299, stock:7,  desc:'Triple-peptide anti-aging eye cream.', sku:'LMR-008', restock:4, image:''},
  ...
  {id:10,name:'Citrus Burst Body Wash',      category:'Wellness',  brand:'AuraBliss', price:549,  stock:22, desc:'Energising gel with natural citrus.', sku:'AUR-010', restock:7, image:''},
  ...
  {id:14,name:'Liquid Highlighter Drops',    category:'Makeup',    brand:'NoirLab',   price:1149, stock:19, desc:'Buildable glow drops for face & body.', sku:'NRL-014', restock:5, image:''},
