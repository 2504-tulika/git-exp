...
from app.schemas.user import UserActivitiesResponse
from app.services.user_service import get_user_activities
...
@router.get(
    ...
    summary="Get current user's activities and stats for dashboard",
)
...
def get_my_activities(
    ...
    """
    Get activities created, joined, requested, or rejected by the current user,
    along with dashboard statistics counts.
    """
    return get_user_activities(db, current_user)
